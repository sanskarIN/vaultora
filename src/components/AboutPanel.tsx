  ...
  return (
    <section className="content-card about-card">
      ...
      <p>
        ...
        Linux. It does not require an account or cloud service.
      </p>
      ...
      <p className="fine-print">
        Security-sensitive software benefits from independent review. Review SECURITY.md and
        THREAT_MODEL.md before relying on Vaultora for high-value secrets.
      </p>
    </section>
  );
}
